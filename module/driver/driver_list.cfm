...
<script>
	...
	var #table_id# = $('###table_id#').DataTable({
		...
		"ajax": $.fn.dataTable.pipeline({
			url: "module/driver/driver_list_data.cfm",
			method: 'GET',
				"data": function(d) {
		...
		[
			...
			},
			{
				...
				render: function (data, type, full) {
					...
					var info_btn = '<a type="button" title="Kemaskini" onclick="driver_info_dsp('+full[0]+');" href="##" class="circle-btn circle-btn-warning"><i class="fa fa-user"></i></a>';
					return info_btn;
				}
			}
		]
	...
	driver_info_dsp = function(data)
      {
		...
		var target = 'module/driver/driver_info.cfm?'+param;
