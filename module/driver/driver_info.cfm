      ...
      <div class="full dis_flex center_text">
         ...
         <div class="profile_contant">
            <div class="contact_inner">
               ...
               <p><strong>Vehicle Type/Modal: </strong>Isuzu D-Max</p>
               <p><strong>Vehicle Number: </strong>SAC 929</p>
            ...
            <div class="user_progress_bar">
               <div class="progress_bar">
                  <!-- Skill Bars -->
                  <span class="skill" style="width:45%;">Total Number Of Trip <span class="info_valume">1000</span></span>                   
                  ...
                  <span class="skill" style="width:55%;">Number Of Trip This Year (#YEAR(NOW())#)<span class="info_valume">257</span></span>                   
                  <div class="progress skill-bar ">
