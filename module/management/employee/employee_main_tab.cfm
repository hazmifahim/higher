                           ...
                           <div class="tabbar padding_infor_info">
                              <nav>
                                 <div class="nav nav-tabs" id="nav-tab" role="tablist">
                                    ...
                                    <a class="nav-item nav-link" id="nav-profile-tab" data-toggle="tab" href="##nav-profile" role="tab" aria-controls="nav-profile" aria-selected="false" data-url="module/management/employee/payroll_settings.cfm?#cgi.QUERY_STRING#"><i class="fa fa-cogs"></i> Payroll Settings</a>
