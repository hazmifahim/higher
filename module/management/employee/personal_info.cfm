         ...
         <div class="col-sm-12">
            ...
            <div class="panel-body">
               <div class="row mb-space">
                  ...
                  <div class="col-sm-6">
                     <div class="row">
                        ...
                        <div class="col-sm-8">
                           <input type="text" id="email" name="email" class="form-control" value="#users.email#" autocomplete="on">
                        </div>
                     </div>
                  </div>
                  <div class="col-sm-6">
                     <div class="row">
                        <label for="ic_no" class="col-sm-4 col-form-label">I.C Number </label>
                        <div class="col-sm-8">
                  ...
                  <div class="col-sm-6">
                     <div class="row">
                        <label for="worker_status" class="col-sm-4 col-form-label">Worker Status </label>
                        <div class="col-sm-8">
                  ...
                  <div class="col-sm-6">
                     <div class="row">
                        <label for="married" class="col-sm-4 col-form-label">Marital Status </label>
                        <div class="col-sm-8">
                  ...
                  <div class="col-sm-6">
                     <div class="row">
                        ...
                        <div class="col-sm-8">
                           <input type="text" id="address" name="address" class="form-control" value="" autocomplete="on">
                        </div>
                     </div>
                  </div>
                  <div class="col-sm-6">
                  ...
                  <div class="col-sm-6">
                     <div class="row">
                        <label for="poscode" class="col-sm-4 col-form-label">Post Code </label>
                        <div class="col-sm-8">
                  ...
                  <div class="col-sm-6">
                     <div class="row">
                        <label for="emergency_name" class="col-sm-4 col-form-label">Emergency Contact Name </label>
                        <div class="col-sm-8">
                  ...
                  <div class="col-sm-6">
                     <div class="row">
                        <label for="emergency_mobile" class="col-sm-4 col-form-label">Emergency Contact No. </label>
                        <div class="col-sm-8">
                  ...
                  <div class="col-sm-6">
                     <div class="row">
                        <label for="bank_acc" class="col-sm-4 col-form-label">Account No.</label>
                        <div class="col-sm-8">
               ...
               <div class="row mb-space">
                  <div class="col-sm-6">
                     <div class="row">
                        <label for="salary_method" class="col-sm-4 col-form-label">Salary Paid Method </label>
                        <div class="col-sm-8">
               ...
               <div class="col-sm-6">
                     <div class="row">
                        <label for="salary_rate" class="col-sm-4 col-form-label">Rate (RM) </label>
                        <div class="col-sm-8">
               ...
               <div class="col-sm-6">
                  <div class="row">
                     <label for="pcb" class="col-sm-4 col-form-label">PCB (RM) </label>
                     <div class="col-sm-8">
                        <input type="text" id="pcb" name="pcb" class="form-control" value="<cfif isdefined("users.pcb") AND users.pcb NEQ "">#users.pcb#<cfelse>0.00</cfif>">
                     </div>
                  </div>
            </div>
            </div>
            ...
            <div class="button_block mt-2"><button type="button" onclick="submit_employee_form();" class="btn cur-p btn-primary">Submit</button></div>
...
<script>
   ...
   function submit_employee_form() {
      $.ajax({
            url: 'module/management/employee/employee_act.cfm',
            type: "POST",
            data : $('##employee_info').serialize(),
            dataType: "script"
      }).fail(function($xhr) {
