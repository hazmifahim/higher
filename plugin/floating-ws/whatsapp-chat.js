    ...
    multipleUser :function(options){
        ...
        if(settings.selector != ''){
            ...
            settings.users.forEach(function (user, index){
                ...
                var image = 'plugin/floating-ws/assets/user.png';
            ...
            if(element !=null){
                var chatBox = '<div class="ayoan_whatsapp_chatbox_container">' +
                    ...
                    '<img class="header-icon" src="plugin/floating-ws/assets/whatsapp.svg"> </div><div class="col col-2">' +
                    ...
                    '<img class="icon" src="plugin/floating-ws/assets/close.svg"></button></div></div>' +
                    '<div class="rs-openChatBtn widget-close-btn-row" >' +
                    '<button type="button" class="rs-openChatBtn widget-close-btn">' +
                    '<img class="icon" src="plugin/floating-ws/assets/whatsapp.svg"></button></div></div>';
