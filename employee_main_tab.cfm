                           ...
                           <div class="tabbar padding_infor_info">
                              <nav>
                                 <div class="nav nav-tabs" id="nav-tab" role="tablist">
                                    <a class="nav-item nav-link active" id="nav-home-tab" data-toggle="tab" href="##nav-home" role="tab" aria-controls="nav-home" aria-selected="true" data-url="personal_info.cfm"><i class="fa fa-user"></i> Personal Info</a>
